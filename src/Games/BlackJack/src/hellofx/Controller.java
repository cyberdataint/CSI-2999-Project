...
public class Controller {
    ...
    public void setDealerCards(GridPane dealergrid, List<Card> hand) {
            ...
            filename = "/hellofx/Card_pics/" +  dealerCard1.toString() + ".png";
            ...
            filename = "/hellofx/Card_pics/" +  "BACK" + ".png";
    ...
    public void displayHand(GridPane gridToDisplayCards, List<Card> hand) {
        ...
        for (int i = 0; i < hand.size(); i++){
            ...
            filename = "/hellofx/Card_pics/" +  cardInHand.toString() + ".png";
